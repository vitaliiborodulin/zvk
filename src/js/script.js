...
$(function () {
	...
	//works-section
	$('a[data-imagelightbox="w1"]').imageLightbox({
		button: true,
		overlay: true,
		quitOnDocClick: true,
		navigation: true,
	...
	$('a[data-imagelightbox="w2"]').imageLightbox({
		button: true,
		overlay: true,
		quitOnDocClick: true,
		navigation: true,
	...
	$('a[data-imagelightbox="w3"]').imageLightbox({
		button: true,
		overlay: true,
		quitOnDocClick: true,
		navigation: true,
	...
	$('a[data-imagelightbox="w4"]').imageLightbox({
		button: true,
		overlay: true,
		quitOnDocClick: true,
		navigation: true,
	...
	$('a[data-imagelightbox="w5"]').imageLightbox({
		button: true,
		overlay: true,
		quitOnDocClick: true,
		navigation: true,
